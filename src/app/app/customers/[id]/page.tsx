  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        badge={<ActiveBadge active={customer.status === "ACTIVE"} />}
        parent={{ label: "العملاء", href: "/app/customers" }}
      />

      <Card>
        <CardContent className="grid grid-cols-1 gap-4 py-4 sm:grid-cols-2 lg:grid-cols-4">
          <InfoField icon={Phone} label="رقم الجوال" value={formatPhoneDisplay(customer.phone)} dir="ltr" />
