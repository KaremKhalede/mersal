  ...
  return (
    <form ref={formRef} action={formAction} className="space-y-4">
      <div className="grid gap-4 lg:grid-cols-3">
        <SectionCard title="معلومات الشركة" icon={Building2} className="lg:col-span-2">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label htmlFor="name" required>اسم الشركة (بالعربية)</Label>
              <Input id="name" name="name" defaultValue={company.name} required />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="nameEn" required>اسم الشركة (بالإنجليزية)</Label>
        ...
        <SectionCard title="الشعار" icon={ImageIcon}>
